...
var Dimmer = function (_Component) {
  ...
  function Dimmer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Dimmer.__proto__ || Object.getPrototypeOf(Dimmer)).call.apply(_ref, [this].concat(args))), _this), _this.handlePortalMount = function () {
      return document.body.classList.add('dimmed', 'dimmable');
    }, _this.handlePortalUnmount = function () {
      return document.body.classList.remove('dimmed', 'dimmable');
  ...
  _createClass(Dimmer, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)('ui', (0, _lib.useKeyOnly)(active, 'active'), (0, _lib.useKeyOnly)(!active, 'disabled'), (0, _lib.useKeyOnly)(inverted, 'inverted'), (0, _lib.useKeyOnly)(page, 'page'), (0, _lib.useKeyOnly)(simple, 'simple'), 'dimmer transition visible', className);
